...
public class RegistrazioneServlet extends HttpServlet {
	...
	@EJB // questa notation dice alla servlet che ProdottoServiceRemote è un ejb 
	private ProdottoServiceRemote prodottoServiceRemote;
    
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		request.getServletContext().getRequestDispatcher("/WEB-INF/view/registrazione.jsp").forward(request, response);
	}
